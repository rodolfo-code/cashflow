...
public class RegisterExpenseTest : IClassFixture<CustomWebApplicationFactory>
{
    ...
    [Fact(DisplayName = nameof(Register_Expense_Success))]
    [Trait("Integation", "Register Expense")]
    public async Task Register_Expense_Success()
    {
    ...
    [Theory(DisplayName = nameof(Error_Title_Name))]
